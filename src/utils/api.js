...
export const fetchParticipants = async (user_id) => {
...
export const addParticipant = async (name, user_id) => {
...
export const clearAllParticipantsExceptUser = async (userId) => {
    const { error } = await supabase
        .from('participants')
        .delete()
        .neq('id', userId);
...
export const ensureUserParticipant = async (userId, name) => {
